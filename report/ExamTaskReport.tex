...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=\textwidth]{../matlab/images/finalnocctv/Application Throughputs.png}
...
\paragraph{The Web browsers} are the parameter continuously changing throughout the simulation, as detailed in section \ref{sec:sim_plan}. Figure \ref{fig:app_throughput} shows that while the overall HTTP traffic throughput rises with the number of web browsing clients, the throughput achieved per browser, demoted as ``Single HTTP throughput'' decreases.
