...
\begin{figure}[!ht]
  ...
  \caption{Packet drop rates at different points in the network} \label{fig:net_throughput}
\end{figure}
...
%Possible spots for bottlenecks are the Main Router's connection to the radio link, and the Access Point or the WLAN itself.

%In fig. \ref{fig:net_throughput}, it can be seen that neither the WLAN nor the radio link throughput reach the radio link's theoretical maximum of 12 Mbit/s.
